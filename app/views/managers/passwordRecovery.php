...
<div class="row">
    <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <h2>Manager Forgot password </h2> <span class="text-muted" id="small_words">Or <a href="<?php echo URLROOT; ?>/users/ManagerLogin">Login</a></span>
            <p>Please fill in the telephone for a password recovery message</p>
            <form action="<?php echo URLROOT; ?>/users/managerForgotPassword" method="post">
